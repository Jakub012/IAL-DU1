...
void List_Dispose( List *list ) {
	...
	{
		ListElementPtr delElement = list->firstElement->nextElement;
		list->firstElement->nextElement = delElement->nextElement;
		free(delElement);
	}
...
void List_InsertFirst( List *list, int data ) {
	ListElementPtr tmp = (ListElementPtr) malloc(sizeof(struct ListElement));
	if(tmp == NULL)
	{
		List_Error();
	}else
...
void List_DeleteAfter( List *list ) {
	...
	{
		ListElementPtr delElement = list->activeElement->nextElement;
